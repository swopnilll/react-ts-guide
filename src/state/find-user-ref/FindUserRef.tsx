...
import { users } from '../find-user/users'
...
const FindUserRef: React.FC = () => {
    ...
    return (
        <>
            ...
            <input type="text" value={searchText} onChange={e => setSearchText(e.target.value)} ref={inputRef} />
